 ...
 * (BSD-2-Clause; license text at https://github.com/mourner/suncalc/blob/master/LICENSE)
 *
 * Vendored for sun-sim per docs/plan/plan.md ADR-001: suncalc@1.9.0, minified build from
 * https://cdnjs.cloudflare.com/ajax/libs/suncalc/1.9.0/suncalc.min.js
 * (cdnjs strips this header at build time; restored here verbatim from the 1.9.0 source).
 */
